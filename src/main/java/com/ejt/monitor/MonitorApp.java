package com.ejt.monitor;

import com.ejt.monitor.config.ApplicationProperties;
import com.ejt.monitor.config.DefaultProfileUtil;
...
public class MonitorApp {
    ...
    public MonitorApp(Environment env) {
        this.env = env;
    }
